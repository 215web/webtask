...
Response.Write "<link href=""images/skin/Css_"&Session("Admin_Style_Num")&"/"&Session("Admin_Style_Num")&".css"" rel=""stylesheet"" type=""text/css"">	" & vbCrLf
...
End If
Response.Write "<table width='100%' border='0' align='center' cellpadding='3' cellspacing='1' class='table'>" & vbCrLf
...
Sub ShowFileThumb()
    Response.Write "<table width='100%' cellpadding='2' cellspacing='1' class='table'><tr class='back' height='22'><td colspan='20' class='xingmu'><b>子目录导航：</b></td></tr><tr class='hback'>"
    ...
    For Each theSubFolder In theFolder.SubFolders
        ...
        If FolderCount Mod 10 = 0 Then Response.Write "</td><tr class='hback'>"
    Next
    Response.Write "</tr></table>" & vbCrLf

    Response.Write "<table width='100%' class='table'><tr class='hback'><td >当前目录：" & RootDir
    If ParentDir <> "" Then
    ...
    End If
    Response.Write "    <table width='100%' border='0' cellspacing='1' cellpadding='3' class='table'>" & vbCrLf
    ...
    Else
        ...
        Response.Write "<table width='100%' border='0' cellpadding='3' cellspacing='1' class='table'>" & vbCrLf
        Response.Write "  <tr>" & vbCrLf
        Response.Write "     <td>" & vbCrLf
        Response.Write "<table width='100%' border='0' align='center' cellpadding='0' cellspacing='3' class='table'>" & vbCrLf
            ...
            ElseIf c > MaxPerPage * (CurrentPage - 1) Then
                If FoundInArr(UpFileType, StrFileType, "|") = True Then
                    ...
                    Case "gif", "jpg", "jpeg", "jpe", "bmp", "png"
                        Response.Write "<img src='" & strPath & "/" & theFiles(i)(0) & "' width='80' height='80' border='0' title='点此图片将返回，点下面的文件名将查看原始文件！'></a>"
                    Case "swf"
                        Response.Write "<img src='images/filetype_flash.gif' width='80' height='80' border='0'></a>"
                    Case "wmv", "avi", "asf", "mpg"
                        Response.Write "<img src='images/filetype_media.gif' width='80' height='80' border='0'></a>"
                    Case "rm", "ra", "ram"
                        Response.Write "<img src='images/filetype_rm.gif' width='80' height='80' border='0'></a>"
                    Case "rar"
                        Response.Write "<img src='images/filetype_rar.gif' width='80' height='80' border='0'></a>"
                    Case "zip"
                        Response.Write "<img src='images/filetype_zip.gif' width='80' height='80' border='0'></a>"
                    Case "exe"
                        Response.Write "<img src='images/filetype_exe.gif' width='80' height='80' border='0'></a>"
                    Case Else
                        Response.Write "<img src='images/filetype_other.gif' width='80' height='100' border='0'></a>"
                    End Select

                    Response.Write "          </td></tr>" & vbCrLf
                    Response.Write "        <tr>" & vbCrLf
                    Response.Write "          <td align='center'><a href='" & strPath & "/" & theFiles(i)(0) & "' target='_blank'>" & theFiles(i)(0) & "</a></td>" & vbCrLf
                    Response.Write "        </tr>" & vbCrLf
                    Response.Write "      </table></td>" & vbCrLf
                
                    FileNum = FileNum + 1
                    If FileNum Mod 5 = 0 Then Response.Write "</td><tr class='hback'>"
                    If PageUnit = 1 Then
...
Sub ShowFileDetail()
    ...
    Else
        Response.Write "<br>"
    End If
    Response.Write "<table width='100%' border='0' cellspacing='0' cellpadding='0' ><tr><td>2当前目录：" & RootDir
    If ParentDir <> "" Then
        Response.Write "/" & ParentDir
    End If
    If CurrentDir <> "" Then
    ...
    Response.Write "    <td class='title0' onmouseout=""this.className='title0'"" onmouseover=""this.className='hbackmouseover1'"">&nbsp;&nbsp;<a href=""javascript:reSort(0);"">文件名&nbsp;&nbsp;<img src='Images/Calendar_Down.gif' border='0' style='display:none' id='Sort0'></a></td>" & vbCrLf
    Response.Write "    <td width='80' align=""right"" class='title0' onmouseout=""this.className='title0'"" onmouseover=""this.className='hbackmouseover1'""><a href=""javascript:reSort(2);"">大小&nbsp;<img src='Images/Calendar_Down.gif' border='0' style='display:none' id='Sort2'></a>&nbsp;</td>" & vbCrLf
    Response.Write "    <td width='180' class='title0' onmouseout=""this.className='title0'"" onmouseover=""this.className='hbackmouseover1'"">&nbsp;<a href=""javascript:reSort(3);"">类型&nbsp;&nbsp;<img src='Images/Calendar_Down.gif' border='0' style='display:none' id='Sort3'></a></td>" & vbCrLf
    Response.Write "    <td width='140' class='title0' onmouseout=""this.className='title0'"" onmouseover=""this.className='hbackmouseover1'""><a href=""javascript:reSort(5);"">上次修改时间&nbsp;&nbsp;<img src='Images/Calendar_Down.gif' border='0' style='display:none' id='Sort5'></a></td>" & vbCrLf
...
Sub ShowFileDetail_Fil()
    If currentSlot > -1 Then
        ...
        For i = 0 To FileCount
            Response.Write "<tr onmouseout=""this.className='hbackmouseout1'"" onmouseover=""this.className='hback1'"">" & vbCrLf
...
Sub showpage2(sfilename, totalnumber, MaxPerPage, ShowMaxPerPage)
    ...
    For i = 1 To TotalPage
        ...
        If chkCLng(CurrentPage) = chkCLng(i) Then strTemp = strTemp & " selected "
