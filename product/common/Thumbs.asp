...
Class Thumb
		...
		Function AddWaterMark(FileName)
			...
			If FileName <> "" And Not IsNull(FileName) Then                           
				...
				If strFileExtName <> "jpg" And strFileExtName <> "gif" And strFileExtName <> "bmp" And strFileExtName <> "png" Then 
					Exit Function
				End If
				Set objFileSystem = ks.InitialObject(Setting(99))
				If objFileSystem.FileExists(FileName) Then             
					If TbSetting(5) <> "0" Then                   
						Select Case TbSetting(5)
							Case "1"                                                           
								If IsObjInstalled("Persits.Jpeg") Then                    
									If IsExpired("Persits.Jpeg") Then
										...
										Response.End
									End If
									If TbSetting(6) = "1" Then             
										AddWordMark 1, TbSetting(8), TbSetting(10), TbSetting(11), TbSetting(12), TbSetting(9), TbSetting(7), FileName
									Else                                               
										AddPhotoMark 1, TbSetting(16), TbSetting(17), TbSetting(13), TbSetting(14), TbSetting(15), TbSetting(7), FileName
									End If
								End If
							Case "2"                                                  
								...
								If IsObjInstalled("wsImage.Resize") Then             
									...
									End If
									If TbSetting(6) = "1" Then             
										AddWordMark 2, TbSetting(8), TbSetting(10), TbSetting(11), TbSetting(12), TbSetting(9), TbSetting(7), FileName
									Else                                               
										AddPhotoMark 2, TbSetting(16), TbSetting(17), TbSetting(13), TbSetting(14), TbSetting(15), TbSetting(7), FileName
									End If
								End If
							Case "3"                                                    
								If IsObjInstalled("SoftArtisans.ImageGen") Then           
									...
									End If
									If TbSetting(6) = "1" Then             
										AddWordMark 3, TbSetting(8), TbSetting(10), TbSetting(11), TbSetting(12), TbSetting(9), TbSetting(7), FileName
									Else                                               
										AddPhotoMark 3, TbSetting(16), TbSetting(17), TbSetting(13), TbSetting(14), TbSetting(15), TbSetting(7), FileName
									End If
								End If
						End Select
					End If
			...
			Select Case MarkComponentID
				Case 1
					...
					If objImage.OriginalWidth < MarkWidth Or objImage.OriginalHeight < MarkHeight Then 
						Exit Function
					End If
					objMark.Open Server.MapPath(pic_path&MarkPicture)
		...
		Function CreateThumbs(FileName, ThumbFileName)
			CreateThumbs = False
			If TbSetting(0) <> "0" And (Not IsNull(TbSetting(0))) Then
				If TbSetting(1) = "0" Then
				   Dim ThumbnailsConfig,Width,Height,GoldenPoint
				   ThumbnailsConfig= Session("ThumbnailsConfig")
				   If ThumbnailsConfig="" Then
				    GoldenPoint= Round(TbSetting(18))
				    Width=CInt(TbSetting(2))
					Height= CInt(TbSetting(3))
				   Else
				...
				Else
					CreateThumbs = CreateThumb(FileName, 0, 0, GoldenPoint,CSng(TbSetting(4)), ThumbFileName)
				End If
			End If
		End Function
		'由原图片生成指定宽度和高度的缩略图
