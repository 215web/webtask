...
<table width="93%"  border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#b1bfee">
  <form action=pay1.asp method=post name=setup>
    ...
    <tr bgcolor="#FFFFFF"> 
      ...
      <td  valign="middle"><input name="self1" type="text" size="33" value="<%=self1%>"> 请填写完整网店域名.如:http://www.shop7z.com</td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td height="30" align="center" valign="middle"><div align="right">网店网址：</div></td>
      <td  valign="middle"><input name="self2" type="text" size="33" value="<%=self2%>">        有可能网店文件不是放在空间根目录下，而是多建了一个文件夹,如shop。这样的话，网店网址请填写http://www.shop7z.com/。如果没有多建文件夹，请填写网店域名即可。</td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
